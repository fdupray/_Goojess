...
///IMPORTANT!!!!
//GOOJESS - AWS MASTER KEY = mkey769876g9876b9876g98768557f765v6587653322--99
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSPlacesClient.provideAPIKey("AIzaSyDzkZIcvZBUY_zuGmQ5DA4CTGVhFTCaW10")
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ...
            ParseMutableClientConfiguration.applicationId = "comehlgoojess05052017simonfred" //"comehlgoojess05052017simonfredaws"
            ParseMutableClientConfiguration.clientKey = nil
            ParseMutableClientConfiguration.server = "https://goojess.herokuapp.com/parse"
        })
