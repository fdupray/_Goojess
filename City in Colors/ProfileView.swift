...
class ProfileView: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDelegate, UITableViewDataSource, TOCropViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if user.currentGeoPoint == nil {
            ...
            geocoder.reverseGeocodeLocation(location, completionHandler: { (placemarks, error) in
                ...
                var currentPlacemark: CLPlacemark! = placemarks![0]
    ...
    func setUpProfileForUser (_ user: CCUser) {
        ...
        self.coverPic.addGestureRecognizer(coverTap)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if location.startDate != nil  {
            ...
            if indexPath.section % 2 == 0 {
                ...
                cell.contentView.backgroundColor = UIColor(red: 139/255, green: 192/255, blue: 228/255, alpha: 1)
            }
                
            else {
                
                cell.contentView.backgroundColor = UIColor(red: 161/255, green: 212/255, blue: 247/255, alpha: 1)
            }
            
            let startDay = Calendar.current.component(.day, from: location.startDate)
            
            let startWeekday = self.dateFormatter.weekdaySymbols[Calendar.current.component(.weekday, from: location.startDate)]
            
            let endWeekday = self.dateFormatter.weekdaySymbols[Calendar.current.component(.weekday, from: location.expiryDate)]
            
            let startMonth = self.dateFormatter.monthSymbols[Calendar.current.component(.month, from: location.startDate)]
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        label.backgroundColor = cityInColorRed
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if isCurrentUser {
            ...
            alert.addAction(UIAlertAction(title: "Delete", style: .destructive, handler: { (action) -> Void in
                ...
                self.mySpots.remove(at: indexPath.row)
